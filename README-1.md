...
> A 24/7 Minecraft Anti-AFK bot system built from scratch — controllable from **6 different methods**: Mobile App, Web Panel, Telegram Bot, Browser URL, Claude AI (via MCP), and PHP Proxy.  
...
│                  CONTROL METHODS                                             │
│                                                                                     │
│  📱 App   🌐 Web Panel   📨 Telegram   🧠 MCP   🔗 API.                    │
└──────────────────────┬──────────────────────────────┘
                       │
                       ▼
┌─────────────────────────────────────────────────────┐
...
│
└── 📦 telegram-setup/           ← Telegram Bot Control
...
## 📨 Telegram Bot — `telegram-setup/`

Control the Minecraft bot directly from Telegram — no browser or app needed.

### Features
- ✅ Send commands via Telegram messages
- ✅ Receive live bot status updates
- ✅ Start, stop, jump, move, sneak — all via chat
- ✅ Works from any phone with Telegram installed
- ✅ No extra app install needed
...
| `/jump` | Start auto-jump |
| `/move` | Start random movement |
| `/sneak` | Enable sneak mode |
...
## 🕹️ 6 Ways to Control the Bot

| # | Method | Best For |
|---|---|---|
| 1 | 📱 **Mobile App** | Quick control from phone, XOR encrypted source |
| 2 | 🌐 **Web Panel** | Full live dashboard, best on PC/tablet |
| 3 | 📨 **Telegram Bot** | Control via chat, no extra app needed |
| 4 | 🧠 **Claude AI via MCP** | Natural language — *"Bot ko hypixel pe connect karo"* |
| 5 | 🔗 **Direct API** | Developers, Postman, JSON responses |
| 6 | 🐘 **PHP Proxy** | Scripts, public-facing integrations, key always hidden |
...
| Web Panel | InfinityFree | — |
| Telegram Bot | Render.com / any Node host | — |
| Mobile App | HopWeb to App | — |
...
| Telegram Bot | node-telegram-bot-api / Telebot |
